...
//This variable have been reassigned
let word = "magnolia";
...
const getWord = async function () {
    ...
    //Here is that you're fetching data from a text file instead of a JSON file. Use .text() instead of .json/
    ...
    //To grab a random word from the file, create a variable to pull a random index from the
